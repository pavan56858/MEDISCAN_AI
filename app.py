...
def analyze_medical_report(text: str) -> Dict[str, Any]:
    ...
    try:
        ...
        medical_keywords = {
            "severe": ["severe", "critical", "acute", "serious", "emergency", "urgent", "life-threatening"],
            "moderate": ["moderate", "mild", "stable", "manageable", "controlled"],
            "symptoms": [
                "fever", "cough", "pain", "fatigue", "headache", "nausea", "dizziness",
                "shortness of breath", "chest pain", "abdominal pain", "vomiting",
                "diarrhea", "constipation", "rash", "swelling", "inflammation",
                "joint pain", "muscle pain", "back pain", "neck pain"
            ],
            "conditions": [
                "diabetes", "hypertension", "asthma", "arthritis", "infection",
                "pneumonia", "bronchitis", "flu", "cold", "fever",
                "heart disease", "stroke", "cancer", "thyroid", "kidney disease",
                "liver disease", "gastrointestinal", "ulcer", "migraine"
            ]
        }
